...
// ErrAllowanceUnavailable marks an introduction allowance that cannot serve a
// new introduction. It is kept as a plain sentinel so that callers can match it
// with errors.Is without depending on the code vocabulary.
var ErrAllowanceUnavailable = errors.New("introduction allowance is not available")
